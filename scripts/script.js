document.addEventListener('DOMContentLoaded', function () {
    ...
    const accountButton = document.getElementById('account-a')?? document.getElementById('settings-a');
    const accountDialog = document.getElementById('account-dialog')?? document.getElementById('settings-dialog');
    const accountForm = document.getElementById('account-form')?? document.getElementById('settings-form');
    const closeButton = document.querySelector('#account-dialog .close-button')?? document.querySelector('#settings-dialog .close-button');
